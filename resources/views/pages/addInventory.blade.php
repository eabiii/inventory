    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('addInventorytoDB') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="type" class="col-md-4 col-form-label text-md-right">Quantity</label>
                        ...
                        <div class="form-group row">
                            <label for="type" class="col-md-4 col-form-label text-md-right">Unit</label>
                        ...
                        <div class="form-group row">
                            <label for="type" class="col-md-4 col-form-label text-md-right">Image Link</label>
